...
type BlockTX struct {
	...
	Nonce           uint64          `json:"nonce,omitempty" gorm:"column:nonce"`
	Type            string          `json:"type,omitempty" gorm:"column:type"`
	Data            string          `json:"data,omitempty" gorm:"column:data"` //the payload data
	Decimal         int             `json:"decimal,omitempty" gorm:"column:decimal"`
	ExecuteResult   string          `json:"execute_result,omitempty" gorm:"column:execute_result"`
	ExecuteError    string          `json:"execute_error,omitempty" gorm:"column:execute_error"`
...
func BatchInsertBlockTX(bs []*BlockTX) error {
	...
	for _, b := range bs {
		vals = append(vals, b.CoinName, b.Txid, b.ContractAddress, b.FromAddress, b.ToAddress, b.BlockHeight, b.BlockHash,
			b.Amount, b.Status, b.GasUsed, b.GasPrice, b.Nonce, b.Data, b.Decimal, b.ExecuteResult, b.ExecuteError, b.Timestamp, b.CreateTime)
	}
	buf := bytes.NewBufferString(`INSERT INTO block_tx(coin_name,txid,contract_address,from_address,to_address,block_height,block_hash,amount,status,gas_used,gas_price,nonce,type,data,decimal,execute_result,execute_error,timestamp,create_time) VALUES `)
