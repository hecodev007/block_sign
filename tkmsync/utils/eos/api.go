...
func (api *API) GetTransactionFromThird(id string) (out *TransactionThirdResp, err error) {
	err = api.call("v2/third/get_transaction", M{"id": id}, &out)
	return
}
...
func (api *API) call(baseAPI string, body interface{}, out interface{}) error {
