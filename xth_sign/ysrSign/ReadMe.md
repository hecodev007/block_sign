####1.启动 ./ysrSign
####2.私钥放在csv目录下
####3.app.toml配置文件放根目录，部署只需要拷贝ysrSign,app.toml，2个文件
####4.common 下放项目公共的组件
####5.utils 放model用到的组件,子文件夹可以用对应的model命名

#测试用例：
#####1.创建账户:
>curl -X POST --url http://127.0.0.1:18081/v1/ysr/createaddr -d '{"num":1,"order_no":"test","mch_name":"hoo","coin_name":"ysr"}' 
#####返回值：
>{
	"code": 0,
	"message": "",
...
#####2.离线签名：
>curl -X POST --url http://127.0.0.1:18081/v1/ysr/sign -d '{"mch_id":1063,"order_no":"10086","mch_name":"635985570@qq.com","coin_name":"telos","data":{"sign_pubkey":"EOS8eqk27VXSg297sGCdey3ZNDYEaw7dqEjDzy52D6VM1i6AnvJu8","token":"ysr.ystar","from_address":"xutonghua123","memo":"test","quantity":"0.0001 YSR","to_address":"111111111111","block_id":"0637fe222aedde5d0c808fdcdb7a3b33cd70b2a5f29526c6b88812f5d75a9f14"}}'
#####返回值：
>{
	"mchId": "hoo",
	"orderId": "10086",
