...
//mainet
var CHAINID,_ = hex.DecodeString("1064487b3cd1a897ce03ae5b6a865651747e2e152090f99c1d19d44e01aea5a4")
...
func (m *EosModel) SignTx(mchName string, pubkey string, txParams *validator.SignParams_Data) (p interface{}, txhash string, err error) {
	...
	log.Info(telosSymbol, txParams.Quantity)
