...
import (
	...
	util "atpSign/utils/alaya"
	"atpSign/utils/keystore"
	"errors"
	"fmt"
)
...
func (m *DagModel) SignTx(params *validator.TelosSignParams) (txhash string, rawTx string, err error) {
...
func (m *DagModel) SendRawTransaction(rawTx string) (err error) {
	return util.SendRawTransaction(rawTx)
}
