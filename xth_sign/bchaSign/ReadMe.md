...
3.app.toml配置文件放根目录，部署只需要拷贝bchaSign,app.toml，2个文件

4.启动 ./bchaSign;

5,创建账户
```
curl -X POST --url  http://127.0.0.1:18095/v1/bcha/createaddr -d '{"num":50,"coinName":"bcha","orderId":"test","mchId":"goapi"}'
```
6,签名
```
