...
3.app.toml配置文件放根目录，部署只需要拷贝starSign,app.toml，2个文件
4.启动 ./starSign
5,创建地址
```
curl -X POST --url  http://127.0.0.1:18083/v1/star/createaddr -d '{"num":50,"coin_name":"star","order_no":"12306","mch_name":"goapi"}'
```
6,签名
```
