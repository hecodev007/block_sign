...
var file_external_proto_rawDesc = []byte{
	...
	0x68, 0x74, 0x74, 0x70, 0x42, 0x6f, 0x64, 0x79, 0x42, 0x38, 0x0a, 0x12, 0x63, 0x6f, 0x6d, 0x2e,
	0x6d, 0x6f, 0x62, 0x69, 0x6c, 0x65, 0x63, 0x6f, 0x69, 0x6e, 0x2e, 0x61, 0x70, 0x69, 0x42, 0x0d,
	0x4d, 0x6f, 0x62, 0x69, 0x6c, 0x65, 0x43, 0x6f, 0x69, 0x6e, 0x41, 0x50, 0x49, 0x5a, 0x13, 0x2e,
	0x2f, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x3b, 0x65, 0x78, 0x74, 0x65, 0x72, 0x6e,
...
var file_external_proto_goTypes = []interface{}{
	(*RistrettoPrivate)(nil),         // 0: RistrettoPrivate
	(*CompressedRistretto)(nil),      // 1: CompressedRistretto
	(*Ed25519Public)(nil),            // 2: Ed25519Public
	(*Ed25519Signature)(nil),         // 3: Ed25519Signature
	(*AccountKey)(nil),               // 4: AccountKey
	(*PublicAddress)(nil),            // 5: PublicAddress
	(*RootIdentity)(nil),             // 6: RootIdentity
	(*RootEntropy)(nil),              // 7: RootEntropy
	(*ViewKey)(nil),                  // 8: ViewKey
	(*CurveScalar)(nil),              // 9: CurveScalar
	(*KeyImage)(nil),                 // 10: KeyImage
	(*Range)(nil),                    // 11: Range
	(*TxOutMembershipHash)(nil),      // 12: TxOutMembershipHash
	(*TxOutMembershipElement)(nil),   // 13: TxOutMembershipElement
	(*TxOutMembershipProof)(nil),     // 14: TxOutMembershipProof
	(*TxOutConfirmationNumber)(nil),  // 15: TxOutConfirmationNumber
	(*Amount)(nil),                   // 16: Amount
	(*EncryptedFogHint)(nil),         // 17: EncryptedFogHint
	(*TxOut)(nil),                    // 18: TxOut
	(*TxIn)(nil),                     // 19: TxIn
	(*TxPrefix)(nil),                 // 20: TxPrefix
	(*RingMLSAG)(nil),                // 21: RingMLSAG
	(*SignatureRctBulletproofs)(nil), // 22: SignatureRctBulletproofs
	(*Tx)(nil),                       // 23: Tx
	(*TxHash)(nil),                   // 24: TxHash
	(*Receipt)(nil),                  // 25: Receipt
	(*VerificationSignature)(nil),    // 26: VerificationSignature
	(*VerificationReport)(nil),       // 27: VerificationReport
}
var file_external_proto_depIdxs = []int32{
	0,  // 0: AccountKey.view_private_key:type_name -> RistrettoPrivate
	0,  // 1: AccountKey.spend_private_key:type_name -> RistrettoPrivate
	1,  // 2: PublicAddress.view_public_key:type_name -> CompressedRistretto
	1,  // 3: PublicAddress.spend_public_key:type_name -> CompressedRistretto
	7,  // 4: RootIdentity.root_entropy:type_name -> RootEntropy
	0,  // 5: ViewKey.view_private_key:type_name -> RistrettoPrivate
	1,  // 6: ViewKey.spend_public_key:type_name -> CompressedRistretto
	11, // 7: TxOutMembershipElement.range:type_name -> Range
	12, // 8: TxOutMembershipElement.hash:type_name -> TxOutMembershipHash
	13, // 9: TxOutMembershipProof.elements:type_name -> TxOutMembershipElement
	1,  // 10: Amount.commitment:type_name -> CompressedRistretto
	16, // 11: TxOut.amount:type_name -> Amount
	1,  // 12: TxOut.target_key:type_name -> CompressedRistretto
	1,  // 13: TxOut.public_key:type_name -> CompressedRistretto
	17, // 14: TxOut.e_fog_hint:type_name -> EncryptedFogHint
	18, // 15: TxIn.ring:type_name -> TxOut
	14, // 16: TxIn.proofs:type_name -> TxOutMembershipProof
	19, // 17: TxPrefix.inputs:type_name -> TxIn
	18, // 18: TxPrefix.outputs:type_name -> TxOut
	9,  // 19: RingMLSAG.c_zero:type_name -> CurveScalar
	9,  // 20: RingMLSAG.responses:type_name -> CurveScalar
	10, // 21: RingMLSAG.key_image:type_name -> KeyImage
	21, // 22: SignatureRctBulletproofs.ring_signatures:type_name -> RingMLSAG
	1,  // 23: SignatureRctBulletproofs.pseudo_output_commitments:type_name -> CompressedRistretto
	20, // 24: Tx.prefix:type_name -> TxPrefix
	22, // 25: Tx.signature:type_name -> SignatureRctBulletproofs
	1,  // 26: Receipt.public_key:type_name -> CompressedRistretto
	15, // 27: Receipt.confirmation:type_name -> TxOutConfirmationNumber
	16, // 28: Receipt.amount:type_name -> Amount
	26, // 29: VerificationReport.sig:type_name -> VerificationSignature
