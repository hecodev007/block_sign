...
go build;
ossutil cp -f ./fioprotocol  oss://dfdfedfda;
ossutil sign oss://dfdfedfda/fioprotocol    --timeout 1000;

pkill -9 fioprotocol;
rm -rf ./fioprotocol;
sudo wget -O fioprotocol  "http://dfdfedfda.oss-cn-hongkong.aliyuncs.com/fioprotocol?Expires=1632652384&OSSAccessKeyId=LTAI8Z8YW8VGkEvg&Signature=WadG0GETuWofEdojrrWk0rSIQHs%3D";
sudo chmod +x ./fioprotocol;
nohup ./fioprotocol &