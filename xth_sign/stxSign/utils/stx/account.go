...
func GenAccount1() (addr string,private string,err error) {
	start:
...
func GenAccount2()(addr string,private string,err error) {
	...
	addr,err = PubToAddr(wif.SerializePubKey())
	return addr,wif.String(),err
}
