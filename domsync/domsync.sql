/*
 ...
 Source Schema         : domsync

 Target Server Type    : MySQL
 Target Server Version : 50736
 File Encoding         : 65001

 Date: 07/05/2022 16:59:12
*/
...
) ENGINE=InnoDB AUTO_INCREMENT=65 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='块信息表';

-- ----------------------------
-- Table structure for block_tx
-- ----------------------------
...
-- ----------------------------
-- Table structure for notifyresult
-- ----------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COMMENT='事件通知表';
