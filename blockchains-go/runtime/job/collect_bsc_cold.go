...
//		log.Fatal(err)
//	}
//	log.Infof("bsc version[%s]", version)
...
//					}
//				}
//				if coin.Name != "usdt-bsc" && coin.Name != "bsc" {
//					to = toAddrs[0]
//				}
//
...
//			if err != nil {
//				log.Errorf("获取bsc币种信息错误：%s", err.Error())
//				return err
//			}
//
//			needLatest := false
...
//
////创建交易接口参数
//func (c *CollectBscJob) walletServerCollect(orderReq *transfer.EthCollectReq) error {
...
//}
//
//func (c *CollectBscJob) getTokenBalance(contractaddress, addr string) (decimal.Decimal, error) {
//	req := transfer.EthBalanceReq{
//		Address:      addr,
...
//}
//
//func (c *CollectBscJob) PendingTxNum(address string) (int, error) {
//	orders, err := entity.FcOrder{}.FindOrders(builder.Eq{"coin_name": c.coinName, "from_address": address, "status": 4}.
//		And(builder.Like{"outer_order_no", "FEE_"}), 50)
//	if err != nil {
//		log.Errorf("查询fc_order error,Err=%v", err)
...
//}
//
//func (c *CollectBscJob) walletServerCreateHot(orderReq *transfer.ETHOrderRequest) (string, error) {
//	if c.cfg.UseLatestNonce {
//		orderReq.Latest = true
//	}
