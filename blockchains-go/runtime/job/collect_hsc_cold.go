...
//		log.Fatal(err)
//	}
//	log.Infof("hsc version[%s]", version)
...
//					}
//				}
//				if coin.Name != "usdt-hsc" && coin.Name != "hsc" {
//					to = toAddrs[0]
//				}
//
...
//			if err != nil {
//				log.Errorf("获取hsc币种信息错误：%s", err.Error())
//				return err
//			}
//
//			needLatest := false
...
//
////创建交易接口参数
//func (c *CollectHscJob) walletServerCollect(orderReq *transfer.EthCollectReq) error {
...
//}
//
//func (c *CollectHscJob) needTransferFee(addresses []string, minAmount float64) bool {
...
//}
//
//func (c *CollectHscJob) isUnFreezeAddress(address string) bool {
//	//v2
...
//	return isUnFreeze
//}
//func (c *CollectHscJob) IsToManyPendingTx(address string) bool {
...
//}
//
//func (c *CollectHscJob) getTokenBalance(contractaddress, addr string) (decimal.Decimal, error) {
//	req := transfer.EthBalanceReq{
//		Address:      addr,
...
//}
//
//func (c *CollectHscJob) PendingTxNum(address string) (int, error) {
//	orders, err := entity.FcOrder{}.FindOrders(builder.Eq{"coin_name": c.coinName, "from_address": address, "status": 4}.
//		And(builder.Like{"outer_order_no", "FEE_"}), 50)
//	if err != nil {
//		log.Errorf("查询fc_order error,Err=%v", err)
...
//}
//
//func (c *CollectHscJob) walletServerCreateHot(orderReq *transfer.ETHOrderRequest) (string, error) {
//	if c.cfg.UseLatestNonce {
//		orderReq.Latest = true
//	}
