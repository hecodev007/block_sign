...
type FcHooTradeList struct {
	...
	//Status       int       `json:"status_" xorm:"not null default 0 comment('对账状态 默认0，0-无需对账，1-对账成功  2-对账失败  3-掉单') TINYINT(2)"`
	Comparison string    `json:"comparison" xorm:"comment('对账信息') VARCHAR(400)"`
