...
type DhxRecycleService struct {
	coinName string
}

func NewDhxRecycleService() *DhxRecycleService {
	return &DhxRecycleService{coinName: "dhx"}
}

func (c *DhxRecycleService) RecycleCoin(mchInfo *entity.FcMch, to string, num int) error {
	//获取币种的配置
...
func (c *DhxRecycleService) walletServerCreateHot(orderReq *transfer.DhxOrderRequest) (string, error) {
