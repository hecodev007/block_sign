...
//)
//
//type BtmRecycleService struct {
//	CoinName    string
//	CoinDecimal int32
//}
//
//func NewBtmRecycleService() *BtmRecycleService {
//	return &BtmRecycleService{CoinName: "btm", CoinDecimal: 8}
//}
//
////params model : 0小额合并 1大额合并
//func (b *BtmRecycleService) RecycleCoin(reqHead *transfer.OrderRequestHead, toAddr string, feeFloat decimal.Decimal, model int) (msg string, err error) {
//	var (
//		addrAms         []*entity.FcAddressAmount
//		scanNum         int
//		btmcoinCfg      *conf.CoinServers                 //币种数据服务
//		addrs           = make([]string, 0)               //utxo地址
//		unspents        *transfer.BtmUnspents             //utxo
//		feeTmp          int64                             //临时估算手续费
//		fromAmountInt64 decimal.Decimal                   //from金额
//		toAmountInt64   decimal.Decimal                   //to金额
//		sortUtxoDesc    transfer.BtmUnspentDesc           //大额
//		sortUtxoAsc     transfer.BtmUnspentAsc            //小额
//		txins           = make([]transfer.BtmTxInTpl, 0)  //utxo模板
//		txouts          = make([]transfer.BtmTxOutTpl, 0) //utxo模板
//		tpl             *transfer.BtmTxTpl                //模板
//	)
//
...
//	btmcoinCfg = conf.Cfg.CoinServers[reqHead.CoinName]
//	if btmcoinCfg == nil {
//		return "", errors.New("配置文件缺少Btmcoin coinservers设置")
//	}
//	log.Infof("发送地址：%s", btmcoinCfg.Url+"/api/v1/btm/unspents")
//	byteData, err := util.PostJson(btmcoinCfg.Url+"/api/v1/btm/unspents", addrs)
//	if err != nil {
...
//		return "", errors.New("btm empty unspents")
//	}
//
...
//	}
//	//手续计算
//	feeTmp, err = b.getBtmFee(len(txins), 1)
//	//step4：组装交易发送给冷签名端
//	toAmountInt64 = fromAmountInt64.Sub(decimal.New(feeTmp, 0))
//	txouts = append(txouts, transfer.BtmTxOutTpl{
//		ToAddr:   toAddr,
...
//
////创建交易接口参数
//func (srv *BtmRecycleService) walletServerCreate(orderReq *transfer.BtmTxTpl) (string, error) {
...
//
////手续费计算
//func (srv *BtmRecycleService) getBtmFee(inNum, outNum int) (int64, error) {
//	var (
//		rate int64 = 1000
//	)
//
