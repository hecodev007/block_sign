...
var (
	ALPHABET        = NewAlphabet("123456789ABCDEFGHJKLMNPQRSWUVTXYZabcdefghijkmnopqrswuvtxyz")
...
func Encode1(input []byte, alphabet *Alphabet) string {
	// prefix 0
...
func Decode1(input string, alphabet *Alphabet) ([]byte, error) {
