...
import (
	...
	"github.com/group-coldwallet/zecserver/api/v1"
	"github.com/group-coldwallet/zecserver/conf"
	_ "github.com/group-coldwallet/zecserver/docs"
	"github.com/group-coldwallet/zecserver/middleware/ginmiddleware"
	"github.com/group-coldwallet/zecserver/middleware/ginmiddleware/jobrunner"
...
func InitRouter(cfg *conf.GlobalConfig, r *gin.Engine) {
	...
	if cfg.SystemModel == "cold" {
		...
		jobrunner.LoadKeyJob(cfg.CronCfg.LoadKeyJob, cfg.ZecCfg.AddrPath, 0, loadService.ReadFile)
	...
	//具体接口实例化
	var apiv1 api.API = v1.NewZecAPI() //v1版本
