...
import (
	...
	"github.com/group-coldwallet/ltcserver/api/v1"
	"github.com/group-coldwallet/ltcserver/conf"
	_ "github.com/group-coldwallet/ltcserver/docs"
	"github.com/group-coldwallet/ltcserver/middleware/ginmiddleware"
	"github.com/group-coldwallet/ltcserver/middleware/ginmiddleware/jobrunner"
...
func InitRouter(cfg *conf.GlobalConfig, r *gin.Engine) {
	...
	if cfg.SystemModel == "cold" {
		...
		jobrunner.LoadKeyJob(cfg.CronCfg.LoadKeyJob, cfg.LtcCfg.AddrPath, loadService.ReadFile)
	...
	//具体接口实例化
	var apiv1 api.API = v1.NewLtcAPI() //v1版本
