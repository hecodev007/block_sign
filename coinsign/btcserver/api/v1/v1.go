...
import (
	...
	"github.com/group-coldwallet/btcserver/api"
	"github.com/group-coldwallet/btcserver/api/e"
	"github.com/group-coldwallet/btcserver/conf"
	...
	"github.com/group-coldwallet/btcserver/service/btcservice"
...
func (a *APIV1) CreateAddrs(c *gin.Context) {
	...
	//限制5w数量
	if params.Num > 50000 {
		api.HttpResponseByMsg(c, http.StatusOK, e.ERROR, "num too big，50000", nil)
		return
	}
	if params.MchId == "" {
	...
	if params.CoinName != "btc" && params.CoinName != "dom" {
