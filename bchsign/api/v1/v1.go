...
import (
	...
	"github.com/group-coldwallet/bchsign/api"
	"github.com/group-coldwallet/bchsign/api/e"
	"github.com/group-coldwallet/bchsign/conf"
	"github.com/group-coldwallet/bchsign/crypto"
	...
	"github.com/group-coldwallet/bchsign/service/bchservice"
	"io/ioutil"
	"net"
	"net/http"
	"net/url"
...
func (a *API) CreateAddrs(c *gin.Context) {
	...
	kmsReq := &secure.RequestPushKey{CoinCode: "bch", Mch: params.Mch}
