...
func (rpc *RpcClient) GetExtrinsicsByNum(height int64) (Extrinsics []string, blockhash string, err error) {
	...
	//}
	return block.Block.Extrinsics, hash, nil
}
...
retry:
	...
	return result.PartialFee.Shift(-18).String(), nil
