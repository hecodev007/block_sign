...
// ProtocolVersion returns the current cdsereum protocol version.
...
// GetFilterChanges polling mcdsod for a filter, which returns an array of logs which occurred since last poll.
...
// Eth1 returns 1 cdsereum value (10^18 wei)
...
// cds1 returns 1 cdsereum value (10^18 wei)
func cds1() *big.Int {
	return big.NewInt(1000000000000000000)
}

func (rpc *RpcClient) getBlock(mcdsod string, withTransactions bool, params ...interface{}) (*Block, error) {
	result, err := rpc.RawCall(mcdsod, "", params...)
	if err != nil {
		return nil, err
	}
...
func (rpc *RpcClient) getTransaction(mcdsod string, params ...interface{}) (*Transaction, error) {
	//transaction := new(Transaction)
	//
	//err := rpc.CallNoAuth(mcdsod, transaction, params...)
