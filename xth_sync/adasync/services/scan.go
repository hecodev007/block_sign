...
//
//	//扫描不可逆区块
//	_, err = s.scanner.ScanIrreverseBlock(s.irrevScanHeight+110, s.irrevScanHeight+120)
//	if err != nil {
//		s.bestHeight = s.irrevScanHeight + 110
...
//
//	for {
//		_, err := s.scanner.ScanIrreverseBlock(s.irrevScanHeight+s.conf.Confirmations, s.irrevScanHeight+s.conf.Confirmations*2)
//		if err != nil {
//			log.Info(err.Error())
...
//		}
//	ScanIrreverseBlock:
//		task, err := s.scanner.ScanIrreverseBlock(s.irrevScanHeight, s.irrevScanHeight+s.conf.Confirmations+1)
//		//defer log.Info("workPool end", workPool.Running, height, bestHeight)
//		//log.Info(xutils.String(task))
//		//panic("")
//		if err != nil {
//			log.Info(err.Error())
...
//		}
//		if task.GetHeight() == 0 {
//			log.Info(s.irrevScanHeight, xutils.String(task))
//			panic("")
//		}
//		s.irrevScanHeight++
//	}
