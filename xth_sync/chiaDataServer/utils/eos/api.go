...
func NewRpcClient(baseURL, apiKey, RPCSecret string) *RpcClient {
	api := &RpcClient{
...
func (api *RpcClient) GetBestHeight() (int64, error) {
...
func (api *RpcClient) GetInfo() (out *InfoResp, err error) {
	err = api.call("v1/chain/get_info", nil, &out)
	return
}

func (api *RpcClient) GetBlockByID(id string) (out *BlockResp, err error) {
...
func (api *RpcClient) GetScheduledTransactionsWithBounds(lower_bound string, limit uint32) (out *ScheduledTransactionsResp, err error) {
...
func (api *RpcClient) GetScheduledTransactions() (out *ScheduledTransactionsResp, err error) {
	return api.GetScheduledTransactionsWithBounds("", 100)
}

func (api *RpcClient) GetProducers() (out *ProducersResp, err error) {
	/*
...
func (api *RpcClient) GetBlockByNum(num int64) (out *BlockResp, err error) {
...
func (api *RpcClient) GetBlockByNumOrID(query int64) (out *BlockResp, err error) {
	err = api.call("v1/chain/get_block", M{"block_num_or_id": query}, &out)
	return
}

func (api *RpcClient) GetBlockByNumOrIDRaw(query string) (out interface{}, err error) {
	err = api.call("v1/chain/get_block", M{"block_num_or_id": query}, &out)
	return
}

func (api *RpcClient) GetTransaction(id string) (out *TransactionResp, err error) {
	err = api.call("v1/history/get_transaction", M{"id": id}, &out)
	return
}
func (api *RpcClient) GetTransactionFromThird(id string) (out *TransactionThirdResp2, err error) {
	err = api.call("v1/history/get_transaction", M{"id": id}, &out)
	return
}

func (api *RpcClient) GetTransactionRaw(id string) (out json.RawMessage, err error) {
	err = api.call("v1/history/get_transaction", M{"id": id}, &out)
	return
}

func (api *RpcClient) GetActions(params GetActionsRequest) (out *ActionsResp, err error) {
	err = api.call("v1/history/get_actions", params, &out)
	return
}

func (api *RpcClient) GetKeyAccounts(publicKey string) (out *KeyAccountsResp, err error) {
	err = api.call("v1/history/get_key_accounts", M{"public_key": publicKey}, &out)
	return
}

func (api *RpcClient) GetControlledAccounts(controllingAccount string) (out *ControlledAccountsResp, err error) {
	err = api.call("v1/history/get_controlled_accounts", M{"controlling_account": controllingAccount}, &out)
	return
}

func (api *RpcClient) GetTransactions(name AccountName) (out *TransactionsResp, err error) {
	err = api.call("v1/account_history/get_transactions", M{"account_name": name}, &out)
	return
}

func (api *RpcClient) GetTableByScope(params GetTableByScopeRequest) (out *GetTableByScopeResp, err error) {
	err = api.call("v1/chain/get_table_by_scope", params, &out)
	return
}

func (api *RpcClient) GetTableRows(params GetTableRowsRequest) (out *GetTableRowsResp, err error) {
	err = api.call("v1/chain/get_table_rows", params, &out)
	return
}

func (api *RpcClient) GetRawABI(params GetRawABIRequest) (out *GetRawABIResp, err error) {
	err = api.call("v1/chain/get_raw_abi", params, &out)
	return
}

func (api *RpcClient) GetCurrencyBalance(account AccountName, symbol string, code AccountName) (out []Asset, err error) {
...
func (api *RpcClient) GetCurrencyStats(code AccountName, symbol string) (out *GetCurrencyStatsResp, err error) {
...
func (api *RpcClient) call(baseAPI string, body interface{}, out interface{}) (err error) {
	defer func() {
		if err != nil {
			log.Error(err.Error())
		}
...
func (api *RpcClient) EnableKeepAlives() bool {
