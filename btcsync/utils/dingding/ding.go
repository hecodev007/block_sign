...
import (
	"btcsync/common/log"
	"btcsync/utils/dingding/dingbot"
	"context"
	"encoding/json"
	"strings"
	"time"
...
//https://oapi.dingtalk.com/robot/send?access_token=33bf8a0a3884fb2707eceec5cbec99f478f820c86d44e9a2305335c05c02f10d
...
func InitDingBot(ctx context.Context) {
	ErrorDingBot = &DingBot{
		Name:   "ding-robot",
		Token:  "33bf8a0a3884fb2707eceec5cbec99f478f820c86d44e9a2305335c05c02f10d",
