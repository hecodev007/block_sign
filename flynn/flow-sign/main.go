...
import (
	...
	"github.com/group-coldwallet/flow-sign/routers"
	v1 "github.com/group-coldwallet/flow-sign/services/v1"
...
func init() {
	...
	flag.IntVar(&nums, "n", 20, "generate key numbers,default is [0]")
}
func main() {
