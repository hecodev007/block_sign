...
func run() (err error) {
	...
	info, err := client.Database.GetTransactionInfo("b2128a46a1d56e6fc642767e74da8a7235bf5fec")
	//fmt.Println(info)
	fmt.Printf("%+v\n", *info)

	status, err := client.Database.GetTransactionStatus("b2128a46a1d56e6fc642767e74da8a7235bf5fec")
	fmt.Printf("%+v\n", *status)
