...
import (
	...
	"steemsign/utils/rpc/internal/call"
...
func (api *API) GetBlock(blockNum uint32) (*Block, error) {
	var resp Block
	if err := api.caller.Call("condenser_api.get_block", blockNum, &resp); err != nil {
		return nil, err
	}
...
//func (api *API) GetTransaction(tx_id string) (*Config, error) {
//	var resp Config
//	if err := api.caller.Call("condenser_api.", call.EmptyParams, &resp); err != nil {
//		return nil, err
//	}
//	return &resp, nil
//}

func (api *API) GetTransactionInfo(tx_id string) (*types.TransactionInfo, error) {
	var resp types.TransactionInfo
	if err := api.caller.Call("condenser_api.get_transaction", tx_id, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (api *API) GetTransactionStatus(tx_id string) (*TransactionStatus, error) {
	var resp TransactionStatus
	if err := api.caller.Call("condenser_api.find_transaction", tx_id, &resp); err != nil {
		return nil, err
	}
	return &resp, nil
}
...
func (api *API) GetOpsInBlock(blockNum uint32, onlyVirtual bool) ([]*types.OperationObject, error) {
	...
	err := api.caller.Call("get_ops_in_block", blockNum, &resp)
	if err != nil {
		return nil, err
	}
	return resp, nil
