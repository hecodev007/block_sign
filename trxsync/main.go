...
import (
	...
	"github.com/group-coldwallet/trxsync/rabbitmq"
	"github.com/group-coldwallet/trxsync/router"
	"github.com/group-coldwallet/trxsync/services"
	"github.com/group-coldwallet/trxsync/services/trx"
...
func main() {
	...
	bs.Init()
	bs.Start()
	go rabbitmq.Consume(watcher, &cfg, true)
	go rabbitmq.Consume(watcher, &cfg, false)
	// 6。初始化推送服务
