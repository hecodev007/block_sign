...
type Block struct {
	...
	// The index of this block in the
...
var file_blockchain_proto_rawDesc = []byte{
	...
	0x65, 0x42, 0x6c, 0x6f, 0x63, 0x6b, 0x52, 0x06, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x73, 0x42, 0x19,
	0x5a, 0x17, 0x2e, 0x2f, 0x62, 0x6c, 0x6f, 0x63, 0x6b, 0x63, 0x68, 0x61, 0x69, 0x6e, 0x3b, 0x62,
...
var file_blockchain_proto_goTypes = []interface{}{
	(*BlockID)(nil),                         // 0: BlockID
	(*BlockContentsHash)(nil),               // 1: BlockContentsHash
	(*Block)(nil),                           // 2: Block
	(*BlockContents)(nil),                   // 3: BlockContents
	(*BlockSignature)(nil),                  // 4: BlockSignature
	(*ArchiveBlockV1)(nil),                  // 5: ArchiveBlockV1
	(*ArchiveBlock)(nil),                    // 6: ArchiveBlock
	(*ArchiveBlocks)(nil),                   // 7: ArchiveBlocks
	(*TxOutMembershipElement)(nil), // 8: TxOutMembershipElement
	(*KeyImage)(nil),               // 9: KeyImage
	(*TxOut)(nil),                  // 10: TxOut
	(*Ed25519Signature)(nil),       // 11: Ed25519Signature
	(*Ed25519Public)(nil),          // 12: Ed25519Public
}
var file_blockchain_proto_depIdxs = []int32{
	0,  // 0: Block.id:type_name -> BlockID
	0,  // 1: Block.parent_id:type_name -> BlockID
	8,  // 2: Block.root_element:type_name -> TxOutMembershipElement
	1,  // 3: Block.contents_hash:type_name -> BlockContentsHash
	9,  // 4: BlockContents.key_images:type_name -> KeyImage
	10, // 5: BlockContents.outputs:type_name -> TxOut
	11, // 6: BlockSignature.signature:type_name -> Ed25519Signature
	12, // 7: BlockSignature.signer:type_name -> Ed25519Public
	2,  // 8: ArchiveBlockV1.block:type_name -> Block
	3,  // 9: ArchiveBlockV1.block_contents:type_name -> BlockContents
	4,  // 10: ArchiveBlockV1.signature:type_name -> BlockSignature
	5,  // 11: ArchiveBlock.v1:type_name -> ArchiveBlockV1
	6,  // 12: ArchiveBlocks.blocks:type_name -> ArchiveBlock
