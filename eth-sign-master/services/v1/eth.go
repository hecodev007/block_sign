...
初始化币种服务
	注意：
		...
		方法命名： 币种大写 + Service
*/
func (bs *BaseService) ETHService() *EthService {
	cs := new(EthService)
	cs.BaseService = bs
	// 初始化连接
...
接口创建地址服务
	无需改动
*/
func (cs *EthService) CreateAddressService(req *model.ReqCreateAddressParams) (*model.RespCreateAddressParams, error) {
...
离线创建地址服务，通过多线程创建
	无需改动
*/
func (cs *EthService) MultiThreadCreateAddrService(nums int, coinName, mchId, orderId string) error {
...
签名服务
*/
func (cs *EthService) SignService(req *model.ReqSignParams) (interface{}, error) {
...
热钱包出账服务
*/
func (cs *EthService) TransferService(req interface{}) (interface{}, error) {
	var (
...
func (cs *EthService) TransferWithNonceService(req interface{}) (interface{}, error) {
...
func (cs *EthService) processTransfer(tp model.EthTransferParams, nonce uint64) (interface{}, error) {
	if tp.FromAddress == "" || tp.ToAddress == "" || tp.Amount == "" {
		return nil, fmt.Errorf("params is null,from=[%s],to=[%s],amount=[%s]", tp.FromAddress, tp.ToAddress, tp.Amount)
	}
	if cs.client == nil {
...
func (cs *EthService) getBuildTxParams(method string, params []interface{}) (*big.Int, error) {
...
func (cs *EthService) getNonce(method, address, tag string) uint64 {
...
创建地址实体方法
*/
func (cs *EthService) createAddressInfo() (util.AddrInfo, error) {
...
*/
func (cs *EthService) makeERC20TransferData(toAddress, transfer_method_id string, amount *big.Int) ([]byte, error) {
	var data []byte
...
*/
func (cs *EthService) ethSign(to string, nonce, gasLimit uint64, value, gasPrice *big.Int, privKey *ecdsa.PrivateKey) (string, bool) {
	// build transaction
...
*/
func (cs *EthService) ethTokenSign(to, toContractAddr string, nonoce, gasLimit uint64, value, gasPrice *big.Int, privKey *ecdsa.PrivateKey) (string, bool) {
...
*/
func (cs *EthService) sign(tx *types.Transaction, privKey *ecdsa.PrivateKey) (string, bool) {
...
func (cs *EthService) aegisNonce(address string) (uint64, error) {
	// 1. 先获取该地址链上的nonce值
...
func (cs *EthService) isPendingStatus(txid string) bool {
...
func (cs *EthService) GetBalance(req *model.ReqGetBalanceParams) (interface{}, error) {
	var (
		data []byte
		err  error
	)
...
func (cs *EthService) ValidAddress(address string) error {
