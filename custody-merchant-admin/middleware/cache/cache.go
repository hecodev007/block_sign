...
const (
	...
	CACHE_MIDDLEWARE_KEY = "hoo.custody.cache"
)

var (
	PageCachePrefix = "hoo.custody.cache.page.cache"
...
func (w *cachedWriter) Write(data []byte) (int, error) {
	...
	if err == nil {
		...
		fmt.Printf("Cache Write status %v \n", w.status)
		fmt.Printf("Cache Write data %v \n", data)
		val := responseCache{
			200,
			header,
			data,
