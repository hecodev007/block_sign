...
import (
	...
	"btmSign/bytom/lib/github.com/tendermint/tmlibs/cli"
	log "github.com/sirupsen/logrus"
	"github.com/spf13/cobra"

	"btmSign/bytom/consensus"
	"btmSign/bytom/toolbar/common"
	cfg "btmSign/bytom/toolbar/vote_reward/config"
	"btmSign/bytom/toolbar/vote_reward/settlementvotereward"
	"btmSign/bytom/toolbar/vote_reward/synchron"
)
