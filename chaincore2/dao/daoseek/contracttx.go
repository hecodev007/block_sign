...
func (b *ContractTX) Insert() (int64, error) {
	o := orm.NewOrm()
	res, err := o.Raw("insert into contract_tx(txid, height, hash, contract_address, fromaddress, toaddress,amount,gaslimit,gasprice,gasused) values(?,?,?,?,?,?,?,?,?,?)",
		b.Txid, b.Height, b.Hash, b.ContractAddress, b.From, b.To, b.Amount, b.GasLimit, b.GasPrice, b.GasUsed).Exec()
	if err == nil {
		num, _ := res.RowsAffected()
		return num, nil
	}
